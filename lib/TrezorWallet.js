...
var _ethUnits = _interopRequireDefault(require("./util/eth-units"));

var _ethUtils = _interopRequireDefault(require("./util/eth-utils"));
...
class TrezorWallet {
  ...
  _formatTxData(txData) {
    return {
      nonce: _ethUtils.default.sanitizeHex(_ethUtils.default.decimalToHex(txData.nonce)),
      gasPrice: _ethUtils.default.sanitizeHex(_ethUtils.default.decimalToHex(_ethUnits.default.unitToUnit(txData.gasPrice, 'gwei', 'wei'))),
      gasLimit: _ethUtils.default.sanitizeHex(_ethUtils.default.decimalToHex(txData.gasLimit)),
      to: _ethUtils.default.sanitizeHex(txData.to),
      value: _ethUtils.default.sanitizeHex(_ethUtils.default.decimalToHex(_ethUnits.default.unitToUnit(txData.value, 'ether', 'wei')))
    };
  }
